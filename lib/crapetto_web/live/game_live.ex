  ...
  defp play(socket, what) do
    ...
    if GameServer.is_locked(game_pid, player) do
      ...
      {result, _game} =
        case what do
          :ligretto ->
            GameServer.play_ligretto(game_pid, player)

          :displayed ->
            GameServer.play_displayed(game_pid, player)

          {:series, n} ->
            GameServer.play_series(game_pid, player, n)

          :show_three ->
            g = GameServer.show_three(game_pid, player)
